...
```sh
git clone https://github.com/kbosa-risc/mcpf-getting-started.git
```
...
* **database_configs**: A list of key-value pairs denoting connection data for each type of database any pipeline functions need access to. Then mandatory key is `type` which discriminates the database type the configuration is for.
...
For particular YAML configuration examples, see [Getting Started](https://github.com/kbosa-risc/mcpf-getting-started/blob/master/README.md).
...
[Getting Started](https://github.com/kbosa-risc/mcpf-getting-started/blob/master/README.md)
